# Nexlayer — standardnotes

**Live:** [https://relaxed-weasel-standardnotes.cloud.nexlayer.ai](https://relaxed-weasel-standardnotes.cloud.nexlayer.ai)  
...
**standardnotes** is deployed on [Nexlayer](https://nexlayer.ai) — a container-native
...
application:
  ...
  pods:
  - name: app
    image: mirror.gcr.io/standardnotes/server:latest
    path: /
    servicePorts:
    - 3000
    vars:
